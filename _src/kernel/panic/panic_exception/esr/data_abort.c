...
void print_data_abort_info(uint64_t iss, uint64_t)
{
    ...
    fkprintf(IO_STDOUT, "\t\tBits[12:11]: %b\n", f.b12_11);

    fkprintf(IO_STDOUT, "\t\tBit[14]: %b\n", f.b14);
    fkprintf(IO_STDOUT, "\t\tBit[15]: %b\n", f.b15);

    fkprintf(IO_STDOUT, "\t\tBits[20:16]: %b\n", f.b20_16);
    ...
    switch (f.SAS) {
        case 0b00:
            fkprint(IO_STDOUT, "\t\tSAS (Syndrome Access Size): Byte\n");
            break;
        case 0b01:
            fkprint(IO_STDOUT, "\t\tSAS (Syndrome Access Size): Halfword\n");
            break;
        case 0b10:
            fkprint(IO_STDOUT, "\t\tSAS (Syndrome Access Size): Word\n");
            break;
        case 0b11:
            fkprint(IO_STDOUT, "\t\tSAS (Syndrome Access Size): Doubleword\n");
            break;
    }
