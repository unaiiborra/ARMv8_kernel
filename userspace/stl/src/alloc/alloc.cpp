...
#define stl_panic()                                                            \
  panic::stl_panic("[stl] allocation panic!\n\rfile: " __FILE__                \
                   "\n\rline: " _TOSTRING(__LINE__) "\n\r")

template <size_t ENTRIES> class CacheEntriesBitmap {
public:
...
template <ArenaCfg Cfg> class CacheArena {
  ...
  static CacheArena<Cfg> *new_tail() {
    int64_t mmap =
        syscall_mmap(NULL, PAGES * PAGE_SIZE, MMAP_PROT_READ | MMAP_PROT_WRITE,
                     MMAP_FLAG_ANONYMOUS, 0,
                     0); // comes memzeroed
...
public:
  ...
  static constexpr bool is_valid() {
    return valid_size() && ENTRIES > 0 && _bitmap_bytes >= 8 && valid_words();
  }
...
static bool stl_pop_allocation_data(void *addr, size_t layout_size,
                                    size_t layout_align,
                                    StlAllocation *allocation) {
...
void get_cache_stats(struct CacheStats *out, size_t *out_count) {
  *out_count = 10;
  ...
  out[0] = {CacheArena<CACHE4_CFG>::count_arenas(),
            CacheArena<CACHE4_CFG>::count_used_entries(), 4};
  out[1] = {CacheArena<CACHE8_CFG>::count_arenas(),
            CacheArena<CACHE8_CFG>::count_used_entries(), 8};
  out[2] = {CacheArena<CACHE16_CFG>::count_arenas(),
            CacheArena<CACHE16_CFG>::count_used_entries(), 16};
  out[3] = {CacheArena<CACHE32_CFG>::count_arenas(),
            CacheArena<CACHE32_CFG>::count_used_entries(), 32};
  out[4] = {CacheArena<CACHE64_CFG>::count_arenas(),
            CacheArena<CACHE64_CFG>::count_used_entries(), 64};
  out[5] = {CacheArena<CACHE128_CFG>::count_arenas(),
            CacheArena<CACHE128_CFG>::count_used_entries(), 128};
  out[6] = {CacheArena<CACHE256_CFG>::count_arenas(),
            CacheArena<CACHE256_CFG>::count_used_entries(), 256};
  out[7] = {CacheArena<CACHE512_CFG>::count_arenas(),
            CacheArena<CACHE512_CFG>::count_used_entries(), 512};
  out[8] = {CacheArena<CACHE1024_CFG>::count_arenas(),
            CacheArena<CACHE1024_CFG>::count_used_entries(), 1024};
  out[9] = {CacheArena<CACHE2048_CFG>::count_arenas(),
            CacheArena<CACHE2048_CFG>::count_used_entries(), 2048};
}
}
#endif
