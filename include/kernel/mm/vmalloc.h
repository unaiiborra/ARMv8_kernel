...
const char *vmalloc_update_tag(vuintptr_t va, const char *new_tag);
...
#define vmalloc_get_mdt(T)                                                                                  \
	_Generic((T), vmalloc_token: __vmalloc_token__vmalloc_get_mdt, void *: __voidptr__vmalloc_get_mdt)( \
		T                                                                                           \
	)
