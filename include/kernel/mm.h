...
#define is_kva(a) _Generic((a), void *: is_kva_ptr, uintptr_t: is_kva_uintptr_t)(a)
...
void *
raw_kmalloc(size_t pages, const char *tag, const raw_kmalloc_cfg *cfg, raw_kmalloc_info *info);
