...
typedef struct {
	...
	int32_t (*irq_set_priority)(driver_handle_t handle, uint32_t irq, uint8_t priority);

	int32_t (*irq_set_target)(driver_handle_t handle, uint32_t irq, uint32_t target_cpu);
