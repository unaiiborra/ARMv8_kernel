...
#define GICV3_DECLARE_BIT_FIELD_GETTER(reg_name, bf_name, RegValueStruct, T, SHIFT, MASK)          \
	MMIO_DECLARE_BIT_FIELD_GETTER(GICV3, reg_name, bf_name, RegValueStruct, T, SHIFT, MASK)

#define GICV3_DECLARE_BIT_FIELD_SETTER(reg_name, bf_name, RegValueStruct, T, SHIFT, MASK)          \
	MMIO_DECLARE_BIT_FIELD_SETTER(GICV3, reg_name, bf_name, RegValueStruct, T, SHIFT, MASK)
...
#define GICV3_SGI_BASE(base, n) (GICV3_REDISTRIBUTOR_N_OFFSET(base, n) + GICV3_SGI_OFFSET)
