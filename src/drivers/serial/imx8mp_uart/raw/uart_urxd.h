...
UART_DECLARE_BIT_FIELD_GETTER(URDX, PRERR, URXD_VALUE_STRUCT_NAME, bool, PRERR_SHIFT, PRERR_MASK);
...
UART_DECLARE_BIT_FIELD_GETTER(URDX, BRK, URXD_VALUE_STRUCT_NAME, bool, BRK_SHIFT, BRK_MASK);
...
UART_DECLARE_BIT_FIELD_GETTER(URDX, ERR, URXD_VALUE_STRUCT_NAME, bool, ERR_SHIFT, ERR_MASK);
