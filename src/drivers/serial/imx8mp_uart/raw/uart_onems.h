...
MMIO_DECLARE_REG32_READER(UART, ONEMS, ONEMS_VALUE_STRUCT_NAME, UART_ONEMS_OFFSET);

MMIO_DECLARE_REG32_WRITER(UART, ONEMS, ONEMS_VALUE_STRUCT_NAME, UART_ONEMS_OFFSET);
