...
void print_data_abort_info(uint64_t iss, uint64_t)
{
	...
	printf("\t\tEA (External abort type): %s\n",
	...
	printf("\t\tISV (Instruction Syndrome Valid): %s\n",
