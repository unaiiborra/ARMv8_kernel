...
void kernel_init(void)
{
	...
	for (kernel_initcall_t *fn = __kernel_initcalls_start; fn < __kernel_initcalls_end; fn++) {
		(*fn)();
	}
...
{
	for (kernel_initcall_t *fn = __kernel_cpu_initcalls_start; fn < __kernel_cpu_initcalls_end;
	     fn++) {
		(*fn)();
	}
